  ...
  [[maybe_unused]] const VectorizedArray<double> element_volume) const
{
	...
	*/
	a_n = (1.0-3.0*constV(epsilon)) * (1.0 + 4.0*constV(epsilon)/(1.0-3.0*constV(epsilon)) * (normal[0]*normal[0]*normal[0]*normal[0]+normal[1]*normal[1]*normal[1]*normal[1]+normal[2]*normal[2]*normal[2]*normal[2]));
	...
	scalarvalueType con_term = (constV((1.0-k)/2.0)/u_con/u_con*(phix[0]*(Dtilde*q_phi*Ux[0]+j_at[0])+phix[1]*(Dtilde*q_phi*Ux[1]+j_at[1])+phix[2]*(Dtilde*q_phi*Ux[2]+j_at[2])));
  ...
  [[maybe_unused]] const VectorizedArray<double> element_volume) const
{
	...
	*/
	scalargradType dan_dphix;
	//We will need to divide by |grad phi|^6
	scalarvalueType gradphi6th;
	gradphi6th = (phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])+constV(regval);
	dan_dphix[0] = 16.0 * constV(epsilon) * phix[0] * (phix[0]*phix[0]*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2]) - (phix[0]*phix[0]*phix[0]*phix[0]+phix[1]*phix[1]*phix[1]*phix[1]+phix[2]*phix[2]*phix[2]*phix[2]))/gradphi6th;
	dan_dphix[1] = 16.0 * constV(epsilon) * phix[1] * (phix[1]*phix[1]*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2]) - (phix[0]*phix[0]*phix[0]*phix[0]+phix[1]*phix[1]*phix[1]*phix[1]+phix[2]*phix[2]*phix[2]*phix[2]))/gradphi6th;
	dan_dphix[2] = 16.0 * constV(epsilon) * phix[2] * (phix[2]*phix[2]*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2]) - (phix[0]*phix[0]*phix[0]*phix[0]+phix[1]*phix[1]*phix[1]*phix[1]+phix[2]*phix[2]*phix[2]*phix[2]))/gradphi6th;
			
	// dimensionless temperature changes
	scalarvalueType z =q_point_loc[2]; // The z-component
	scalarvalueType t_n =constV(this->currentTime); // The time
	scalarvalueType tep =((z-constV(z0)-Vtilde*t_n)/ltilde);
	...
	*/
	aniso[0] = a_n*a_n*phix[0]+a_n*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])*dan_dphix[0];
	aniso[1] = a_n*a_n*phix[1]+a_n*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])*dan_dphix[1];
	aniso[2] = a_n*a_n*phix[2]+a_n*(phix[0]*phix[0]+phix[1]*phix[1]+phix[2]*phix[2])*dan_dphix[2];
