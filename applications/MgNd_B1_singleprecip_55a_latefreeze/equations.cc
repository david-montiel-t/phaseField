...
#define rn1V_freeze  (n1)
#define rn1xV_freeze  (constV(0.0)*gamma*Knx1)
...
#define rn2V_freeze  (n2)
#define rn2xV_freeze  (constV(0.0)*gamma*Knx2)
...
#define rn3V_freeze   (n3)
#define rn3xV_freeze  (constV(0.0)*gamma*Knx3)
...
if (this->currentTime < 291600.0) {
	...
	variable_list.set_scalar_value_term_RHS(1,rn1V_freeze  + source_terms[0]);
	variable_list.set_scalar_gradient_term_RHS(1,rn1xV_freeze );

	variable_list.set_scalar_value_term_RHS(2,rn2V_freeze  + source_terms[1]);
	variable_list.set_scalar_gradient_term_RHS(2,rn2xV_freeze );

	variable_list.set_scalar_value_term_RHS(3,rn3V_freeze  + source_terms[2]);
	variable_list.set_scalar_gradient_term_RHS(3,rn3xV_freeze );	
}
