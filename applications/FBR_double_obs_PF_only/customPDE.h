...
// Function to set the nucleation probability (in nucleation.h)
  ...
  double U = userInputs.get_model_constant_double("U");
  double KnV = userInputs.get_model_constant_double("KnV");
  double mu = userInputs.get_model_constant_double("mu");
  double lt = userInputs.get_model_constant_double("lt");
  double r0 = userInputs.get_model_constant_double("r0");
  double l_init = userInputs.get_model_constant_double("l_init");
